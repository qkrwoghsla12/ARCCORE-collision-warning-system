...
#define ALARM_ID_OsAlarmSonar	((AlarmType)1)
#define ALARM_ID_OsAlarmCollisionDetection	((AlarmType)2)
#define ALARM_ID_OsAlarmLED	((AlarmType)3)
...
// Event masks
#define EVENT_MASK_OsSonarEvent	 (EventMaskType)((EventMaskType)1u<<0)
#define EVENT_MASK_OsCollisionDetectionEvent	 (EventMaskType)((EventMaskType)1u<<1)
#define EVENT_MASK_OsLEDEvent	 (EventMaskType)((EventMaskType)1u<<2)
...
#define TASK_ID_OsCollisionDetectionTask	((TaskType)2)
#define TASK_ID_OsLEDTask	((TaskType)3)
#define TASK_ID_OsSonarTask	((TaskType)4)
#define TASK_ID_OsStartupTask	((TaskType)5)
...
void OsCollisionDetectionTask ( void );
void OsLEDTask ( void );
void OsSonarTask ( void );
