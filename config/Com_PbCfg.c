...
#if (COM_MAX_BUFFER_SIZE < 96)
#error Com: The configured ram buffer size is less than required! (96 bytes required)
#endif
 ...
 * Signal init values.
 */
SECTION_POSTBUILD_DATA const uint32 Com_SignalInitValue_CanRxSignal = 0;
SECTION_POSTBUILD_DATA const uint32 Com_SignalInitValue_CanTxSignal = 0;
...
SECTION_POSTBUILD_DATA const ComSignal_type ComSignal[] = {
    ...
    { // CanRxSignal
        .ComHandleId                = ComConf_ComSignal_CanRxSignal,
        .ComIPduHandleId            = ComConf_ComIPdu_CanRxIPdu,
        // @req COM292          
        ...
        .ComSignalInitValue         = &Com_SignalInitValue_CanRxSignal,
        .ComBitPosition             = 0,
        .ComBitSize                 = 32,
    ...
    { // CanTxSignal
        .ComHandleId                = ComConf_ComSignal_CanTxSignal,
        .ComIPduHandleId            = ComConf_ComIPdu_CanTxIPdu,
        .ComFirstTimeoutFactor      = 0,      
        .ComNotification            = COM_NO_FUNCTION_CALLOUT,        
        .ComTimeoutFactor           = 0,
        .ComTimeoutNotification     = COM_NO_FUNCTION_CALLOUT,
        ...
        .ComUpdateBitPosition       = 0,
        .ComSignalArcUseUpdateBit   = FALSE,
        .ComSignalInitValue         = &Com_SignalInitValue_CanTxSignal,
        .ComBitPosition             = 0,
        .ComBitSize                 = 32,
        .ComSignalEndianess         = COM_LITTLE_ENDIAN,
        .ComSignalType              = COM_UINT32,
...
SECTION_POSTBUILD_DATA const ComSignal_type * const ComIPduSignalRefs_CanRxIPdu[] = {
	&ComSignal[ComConf_ComSignal_CanRxSignal],
	NULL
};

SECTION_POSTBUILD_DATA const ComSignal_type * const ComIPduSignalRefs_CanTxIPdu[] = {
	&ComSignal[ComConf_ComSignal_CanTxSignal],
	NULL
};
 ...
 */
SECTION_POSTBUILD_DATA const ComIPduGroup_type ComIpduGroupRefs_CanRxIPdu[] = {
	{
		.ComIPduGroupHandleId 		= ComConf_ComIPduGroup_ComIPduGroupRx,
		.Com_Arc_EOL 				= 0
	},
...
SECTION_POSTBUILD_DATA const ComIPduGroup_type ComIpduGroupRefs_CanTxIPdu[] = {
	{
		.ComIPduGroupHandleId 		= ComConf_ComIPduGroup_ComIPduGroupTx,
		.Com_Arc_EOL 				= 0
	},
...
SECTION_POSTBUILD_DATA const ComIPdu_type ComIPdu[] = {	
	...
	{ // CanRxIPdu
		...
		.ComIPduGroupRefs			= ComIpduGroupRefs_CanRxIPdu,
		.ComTxIPdu = {
		...
		.ComIPduSignalRef			= ComIPduSignalRefs_CanRxIPdu,
	...
	{ // CanTxIPdu
		...
		.ComIPduGroupRefs			= ComIpduGroupRefs_CanTxIPdu,
		.ComTxIPdu = {
			.ComTxIPduMinimumDelayFactor	= 0,
			.ComTxIPduUnusedAreasDefault	= 0,
		...
		.ComIPduSignalRef			= ComIPduSignalRefs_CanTxIPdu,
		.ComIPduDynSignalRef		= NULL,
		.ComIpduCounterRef			= NULL,
		.ComIPduGwMapSigDescHandle	= NULL,
		.ComIPduGwRoutingReq		= FALSE,
