 ...
 */
#ifndef RTE_MODEMANAGERSWC_H_
#define RTE_MODEMANAGERSWC_H_
...
extern Std_ReturnType Rte_Call_ModeManagerSWC_modeManagerInitSWC_RunControl_RequestRUN(void);
...
} Rte_CDS_ModeManagerSWC;

/** --- Instance handle type ---------------------------------------------------------------------- */
typedef Rte_CDS_ModeManagerSWC const * const Rte_Instance;

/** --- Singleton instance handle -----------------------------------------------------------------
 *  @req SWS_Rte_03793
 */
extern const Rte_Instance Rte_Inst_ModeManagerSWC;
#define self (Rte_Inst_ModeManagerSWC)
...
static inline Std_ReturnType Rte_Call_RunControl_RequestRUN(void) {
    return Rte_Call_ModeManagerSWC_modeManagerInitSWC_RunControl_RequestRUN();
}
