...
Std_ReturnType Rte_Call_UltraSonicSWC_ultrasonicSWC_SonarEcho_Read(/*OUT*/DigitalLevel * Level, /*OUT*/SignalQuality * Quality) {
    return Rte_Call_IoHwAb_ioHwAb_DigitalSonarEcho_Read(Level, Quality);
}

/** ------ SonarSend */
/*lint -e621 MISRA:OTHER:Ignore misidentified symbol clash [MISRA 2012 Rule 5.5, required]*/
Std_ReturnType Rte_Write_UltraSonicSWC_ultrasonicSWC_SonarSend_distance(/*IN*/IntImpl value) {
    Std_ReturnType retVal = RTE_E_OK;

    /* --- Sender (ultrasonicSWC_SonarSend_to_cantranslateSWC_SonarRecv) */
    {
        SYS_CALL_AtomicCopy32(Rte_Buffer_cantranslateSWC_SonarRecv_distance, value);
    }

    /* --- Sender (ultrasonicSWC_SonarSend_to_collisiondetectionSWC_SonarRecv) */
    {
        SYS_CALL_AtomicCopy32(Rte_Buffer_collisiondetectionSWC_SonarRecv_distance, value);
    }
...
Std_ReturnType Rte_Call_UltraSonicSWC_ultrasonicSWC_SonarTrig_Write(/*IN*/DigitalLevel Level) {
    return Rte_Call_IoHwAb_ioHwAb_DigitalSonarTrig_Write(Level);
}
