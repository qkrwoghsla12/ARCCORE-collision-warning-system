...
#define PortConf_PortPin_CAN0TX ((Port_PinType)0)
#define PortConf_PortPin_CAN0RX ((Port_PinType)1)
#define PortConf_PortPin_FrontLED ((Port_PinType)2)
#define PortConf_PortPin_RearLED ((Port_PinType)3)
#define PortConf_PortPin_Sonar_Echo ((Port_PinType)4)
#define PortConf_PortPin_Sonar_Trig ((Port_PinType)5)
