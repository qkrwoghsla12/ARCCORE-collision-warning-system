...
GEN_ALARM_AUTOSTART(
				ALARM_ID_OsAlarmCollisionDetection,
				ALARM_AUTOSTART_RELATIVE,
				20,
				20,
				OSDEFAULTAPPMODE );
...
,
	GEN_ALARM(	ALARM_ID_OsAlarmSonar,
				"OsAlarmSonar",
				COUNTER_ID_OsCounter,
				GEN_ALARM_AUTOSTART_NAME(ALARM_ID_OsAlarmSonar),
				ALARM_ACTION_SETEVENT,
				TASK_ID_OsSonarTask,
				EVENT_MASK_OsSonarEvent,
				0,
				APPLICATION_ID_OsApplication, /* Application owner */
				(( 1u << APPLICATION_ID_OsApplication ) 
				) /* Accessing application mask */
...
,
	GEN_ALARM(	ALARM_ID_OsAlarmCollisionDetection,
				"OsAlarmCollision",
				COUNTER_ID_OsCounter,
				GEN_ALARM_AUTOSTART_NAME(ALARM_ID_OsAlarmCollisionDetection),
				ALARM_ACTION_SETEVENT,
				TASK_ID_OsCollisionDetectionTask,
				EVENT_MASK_OsCollisionDetectionEvent,
				0,
				APPLICATION_ID_OsApplication, /* Application owner */
				(( 1u << APPLICATION_ID_OsApplication ) 
				) /* Accessing application mask */
...
,
	GEN_ALARM(	ALARM_ID_OsAlarmLED,
				"OsAlarmLED",
				COUNTER_ID_OsCounter,
				GEN_ALARM_AUTOSTART_NAME(ALARM_ID_OsAlarmLED),
				ALARM_ACTION_SETEVENT,
				TASK_ID_OsLEDTask,
				EVENT_MASK_OsLEDEvent,
				0,
				APPLICATION_ID_OsApplication, /* Application owner */
				(( 1u << APPLICATION_ID_OsApplication ) 
				) /* Accessing application mask */
...
DECLARE_STACK(OsCollisionDetectionTask,  2048);
DECLARE_STACK(OsLEDTask,  2048);
DECLARE_STACK(OsSonarTask,  2048);
...
{
	.pid = TASK_ID_OsCollisionDetectionTask,
	.name = "OsCollisionDetectionTask",
	.entry = OsCollisionDetectionTask,
	.prio = 3,
	.scheduling = FULL,
	.proc_type = PROC_EXTENDED,
	.stack = {
		.size = sizeof stack_OsCollisionDetectionTask,
		.top = stack_OsCollisionDetectionTask,
	},
	.autostart = TRUE,
	...
	.resourceAccess = 0 , 
	.activationLimit = 1,
	.eventMask = 0 | EVENT_MASK_OsCollisionDetectionEvent ,
...

{
	...
	.resourceAccess = 0 , 
	.activationLimit = 1,
	.eventMask = 0 | EVENT_MASK_OsLEDEvent ,
...

{
	...
	.proc_type = PROC_EXTENDED,
	.stack = {
		.size = sizeof stack_OsSonarTask,
		.top = stack_OsSonarTask,
	},
	.autostart = TRUE,
	...
	.resourceAccess = 0 , 
	.activationLimit = 1,
	.eventMask = 0 | EVENT_MASK_OsSonarEvent ,
