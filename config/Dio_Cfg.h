...
// Channels
#define DioConf_DioChannel_FrontLED 98u
#define Dio_FrontLED DioConf_DioChannel_FrontLED
#define DioConf_DioChannel_RearLED 99u
#define Dio_RearLED DioConf_DioChannel_RearLED
#define DioConf_DioChannel_SonarEcho 174u
#define Dio_SonarEcho DioConf_DioChannel_SonarEcho
#define DioConf_DioChannel_SonarTrig 175u
#define Dio_SonarTrig DioConf_DioChannel_SonarTrig

// Channel groups


// Ports
#define DioConf_DioPort_LED (DIO_PORT_G)
#define Dio_LED DioConf_DioPort_LED
#define DioConf_DioPort_UltraSonic (DIO_PORT_K)
#define Dio_UltraSonic DioConf_DioPort_UltraSonic
